...
<link rel="stylesheet" href="../reources/addproduct.css">
<link rel="icon" href="../reources/img/shopee-logo.png"
	type="image/x-icon">
...
<body>
	...
	<form action="add" method="post">
		<label for="lname">Tên</label> <input type="text" name="name"><br>
  		<label for="lname">Giá</label> <input type="text" name="price"><br> 
  		<label for="lname">Hình</label> <input type="text" name="image"><br>
